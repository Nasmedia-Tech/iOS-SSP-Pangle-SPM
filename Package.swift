...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-AdMixerDownload/raw/main/AdMixerMediationPangle1.0.5.xcframework.zip",
            checksum: "3cf6fc02d51fdabf3be065c7d6a876af6854af53628015a94675f197832bb9c0"
        ),
        .target(
