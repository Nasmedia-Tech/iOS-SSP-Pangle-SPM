...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-Pangle-SPM/releases/download/1.2.6/AdMixerMediationPangle1.2.6.xcframework.zip",
            checksum: "e64f5bc1bf0fa2825898a8bf66b1d83a10a47fd83ee8c82af8dfa695b6ac5e9d"
        ),
        .target(
