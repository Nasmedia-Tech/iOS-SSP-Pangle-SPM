...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-Pangle-SPM/releases/download/1.2.2/AdMixerMediationPangle1.2.2.xcframework.zip",
            checksum: "a31b19d25533bbe2dd857ddf4271367b8212a79550d1d76d411f2646c872a7f7"
        ),
        .target(
